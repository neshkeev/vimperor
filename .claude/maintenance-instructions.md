...
#   vim-engine/src/main/kotlin/com/github/neshkeev/vimperor/{js,jvm}/   per-platform engine code
...
source root nested inside the base package - `src/main/kotlin/com/github/neshkeev/vimperor/{jvm,js}`.
