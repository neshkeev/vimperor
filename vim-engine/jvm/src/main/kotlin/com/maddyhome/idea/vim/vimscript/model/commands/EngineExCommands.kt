...
// `EngineExCommandsKt` and the compilation fails. The names are deliberately identical, an
// `actual` beside its `expect`, so the facade moves instead of the file.
@file:JvmName("EngineExCommandsJvm")

package com.maddyhome.idea.vim.vimscript.model.commands

actual val engineExCommandProvider: ExCommandProvider = EngineExCommandProvider
