 ...
 * @author vlan
 */
class KeyMapping(private val mode: MappingMode) : Iterable<List<VimKeyStroke>> {
   ...
   */
  fun getAll(prefix: List<VimKeyStroke>, includePrefixMappings: Boolean = true): Sequence<KeyMappingEntry> =
