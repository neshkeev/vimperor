...
class KeyStrokeTrie<T>(private val name: String) {
  ...
  private val root = TrieNodeImpl<T>(
    name = "",
    key = VimKeyStroke.getKeyStroke(VimKeyCodes.CHAR_UNDEFINED),
    parent = null,
    data = null
  )
   ...
   */
  fun getEntries(prefix: List<VimKeyStroke>? = null, includePrefixNodes: Boolean = false): Sequence<TrieNode<T>> {
