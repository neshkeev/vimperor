...
What does not: 15 of the 26 bundled extensions — surround, commentary, matchit and
...
`textobj-indent` and `argtextobj` are ported, and are the pattern for the others. Not
