...
internal class CollectionElementVisitor : RegexParserBaseVisitor<Pair<CollectionElement, Boolean>>() {
  ...
  override fun defaultResult(): Pair<CollectionElement, Boolean> =
    error("CollectionElementVisitor: no default result, every collection_elem alternative has an override")
