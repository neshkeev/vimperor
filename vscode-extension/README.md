...
- **Vim plugins.** There is no `pack/` directory, and 21 of IdeaVim's 26 bundled extensions —
  surround, commentary, targets and the rest — are not ported yet. Five are, and they are enabled
